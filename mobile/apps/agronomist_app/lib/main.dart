  ...
  Workmanager().executeTask((task, inputData) async {
    switch (task) {
      case 'syncData':
        ...
        return true;
      case 'syncFieldInspections':
        Logger('BackgroundSync').info('Syncing pending field inspections');
        return true;
      case 'syncAdvisories':
        Logger('BackgroundSync').info('Syncing crop advisories');
        return true;
      default:
        return true;
    }
...
void notificationTapBackground(NotificationResponse response) {
  Logger('Notifications')
      .info('Background notification tapped: ${response.id}');
}
