...
class FieldInspectionRemoteDataSourceImpl
  ...
  Future<ConnectResponse> _callUnary(
    ...
    if (!response.isSuccess) {
      throw FieldInspectionRemoteException(
        'RPC call $_servicePath/$method failed',
  ...
  Future<List<InspectionModel>> getInspections({String? farmId}) async {
    ...
    final response = await _callUnary('ListInspections', request);
    final result =
  ...
  Future<InspectionModel> getInspectionById(String id) async {
    ...
    final response = await _callUnary('GetInspection', request);
    final result =
  ...
  Future<InspectionModel> createInspection(InspectionModel inspection) async {
    ...
    final response = await _callUnary('CreateInspection', request);
    final result =
  ...
  Future<InspectionModel> submitInspection(String inspectionId) async {
    ...
    final response = await _callUnary('SubmitInspection', request);
    final result =
