...
abstract final class AppConfig {
  ...
  /// GPS tracking: minimum distance filter in meters.
  static const int gpsDistanceFilter = 5;

  /// GPS tracking: location accuracy.
  static const String gpsAccuracy = 'high';
  ...
  /// Maximum number of photos per observation.
  ...
  /// App name.
  static const String appName = 'YieldPoint Farmer';
