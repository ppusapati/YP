//! Image preprocessing for nutrient deficiency detection.
//!
//! Mirrors the Python transforms from `nutrient_deficiency/transforms.py`:
...
/// Default input image size for DenseNet-121.
...
/// Preprocessing configuration matching DenseNet-121 validation transforms.
#[derive(Debug, Clone)]
...
/// Preprocess an image for nutrient deficiency inference.
