...
func main() {
	...
	// Build ServiceDeps — the rich repository and service require this.
	d := deps.ServiceDeps{
		Pool: pool,
		Log:  logger,
	}

	// Rich implementation wiring
	repo := repositories.NewTraceabilityRepository(d)
	svc := services.NewTraceabilityService(d, repo)
