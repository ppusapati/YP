...
func (r *traceabilityRepository) CreateRecord(ctx context.Context, record *domain.TraceabilityRecord) (*domain.TraceabilityRecord, error) {
	...
	if err != nil {
		r.log.Errorw("msg", "failed to create traceability record", "error", err)
		return nil, errors.Internal("failed to create traceability record: %v", err)
	}
	return &result, nil
}

func (r *traceabilityRepository) GetRecord(ctx context.Context, id, tenantID string) (*domain.TraceabilityRecord, error) {
	...
	if err != nil {
		...
		r.log.Errorw("msg", "failed to get traceability record", "error", err)
...
func (r *traceabilityRepository) ListRecords(ctx context.Context, tenantID string, filter domain.ListRecordsFilter) ([]domain.TraceabilityRecord, int64, error) {
	...
	if err != nil {
		r.log.Errorw("msg", "failed to count traceability records", "error", err)
	...
	if err != nil {
		r.log.Errorw("msg", "failed to list traceability records", "error", err)
		return nil, 0, errors.Internal("failed to list traceability records: %v", err)
	}
	defer rows.Close()

	var records []domain.TraceabilityRecord
	for rows.Next() {
		var rec domain.TraceabilityRecord
		if err := rows.Scan(
			...
			r.log.Errorw("msg", "failed to scan traceability record", "error", err)
...
func (r *traceabilityRepository) UpdateRecordCompliance(ctx context.Context, id, tenantID string, status domain.ComplianceStatusType, updatedBy string) (*domain.TraceabilityRecord, error) {
...
func (r *traceabilityRepository) UpdateRecordQR(ctx context.Context, id, tenantID, qrData, updatedBy string) (*domain.TraceabilityRecord, error) {
	query := `UPDATE traceability_records
...
func (r *traceabilityRepository) AppendChainOfCustody(ctx context.Context, id, tenantID, custodyEntry, updatedBy string) (*domain.TraceabilityRecord, error) {
	query := `UPDATE traceability_records
...
func (r *traceabilityRepository) CreateSupplyChainEvent(ctx context.Context, event *domain.SupplyChainEvent) (*domain.SupplyChainEvent, error) {
	...
	var result domain.SupplyChainEvent
	err := r.pool.QueryRow(ctx, query,
	...
	if err != nil {
		r.log.Errorw("msg", "failed to create supply chain event", "error", err)
		return nil, errors.Internal("failed to create supply chain event: %v", err)
	}
	return &result, nil
}

func (r *traceabilityRepository) GetSupplyChainEventsByRecord(ctx context.Context, recordID string) ([]domain.SupplyChainEvent, error) {
...
func (r *traceabilityRepository) CreateCertification(ctx context.Context, cert *domain.Certification) (*domain.Certification, error) {
	...
	if err != nil {
		r.log.Errorw("msg", "failed to create certification", "error", err)
		return nil, errors.Internal("failed to create certification: %v", err)
	}
	return &result, nil
}

func (r *traceabilityRepository) GetCertification(ctx context.Context, id, tenantID string) (*domain.Certification, error) {
...
func (r *traceabilityRepository) ListCertifications(ctx context.Context, tenantID string, filter domain.ListCertificationsFilter) ([]domain.Certification, int64, error) {
	baseWhere := `WHERE tenant_id = $1`
	args := []interface{}{tenantID}
	argIdx := 2
...
func (r *traceabilityRepository) VerifyCertification(ctx context.Context, id, tenantID, verifiedBy string) (*domain.Certification, error) {
...
func (r *traceabilityRepository) GetCertificationsByRecord(ctx context.Context, recordID, tenantID string) ([]domain.Certification, error) {
	query := `SELECT id, tenant_id, record_id, cert_type, cert_number, issued_by,
		issued_date, expiry_date, status, verified_by, verified_at,
		metadata, version, created_at, updated_at
...
func (r *traceabilityRepository) GetActiveCertificationsByRecord(ctx context.Context, recordID, tenantID string) ([]domain.Certification, error) {
	query := `SELECT id, tenant_id, record_id, cert_type, cert_number, issued_by,
		issued_date, expiry_date, status, verified_by, verified_at,
		metadata, version, created_at, updated_at
...
func (r *traceabilityRepository) CreateBatchRecord(ctx context.Context, batch *domain.BatchRecord) (*domain.BatchRecord, error) {
...
func (r *traceabilityRepository) ListBatchRecords(ctx context.Context, tenantID string, filter domain.ListBatchesFilter) ([]domain.BatchRecord, int64, error) {
	baseWhere := `WHERE tenant_id = $1`
	args := []interface{}{tenantID}
	argIdx := 2
	...
	var batches []domain.BatchRecord
	for rows.Next() {
...
func (r *traceabilityRepository) CreateQRCode(ctx context.Context, qr *domain.QRCodeRecord) (*domain.QRCodeRecord, error) {
	...
	var result domain.QRCodeRecord
	err := r.pool.QueryRow(ctx, query,
	...
	if err != nil {
		r.log.Errorw("msg", "failed to create QR code", "error", err)
		return nil, errors.Internal("failed to create QR code: %v", err)
	}
	return &result, nil
}

func (r *traceabilityRepository) GetQRCodeByData(ctx context.Context, qrData string) (*domain.QRCodeRecord, error) {
...
func (r *traceabilityRepository) GetQRCodesByRecord(ctx context.Context, recordID string) ([]domain.QRCodeRecord, error) {
	query := `SELECT id, record_id, batch_id, qr_data, qr_image_url, scan_url,
		generated_at, expires_at, is_active
	...
	var qrs []domain.QRCodeRecord
	for rows.Next() {
		var q domain.QRCodeRecord
		if err := rows.Scan(
...
func (r *traceabilityRepository) CreateComplianceReport(ctx context.Context, report *domain.ComplianceReport) (*domain.ComplianceReport, error) {
	...
	if err != nil {
		r.log.Errorw("msg", "failed to create compliance report", "error", err)
		return nil, errors.Internal("failed to create compliance report: %v", err)
	}
	return &result, nil
}

func (r *traceabilityRepository) GetComplianceReport(ctx context.Context, id, tenantID string) (*domain.ComplianceReport, error) {
...
func (r *traceabilityRepository) GetComplianceReportsByRecord(ctx context.Context, recordID, tenantID string) ([]domain.ComplianceReport, error) {
	query := `SELECT id, tenant_id, record_id, status, report_type,
		findings, recommendations, auditor, audit_date,
		next_audit_date, compliance_score, metadata, created_at
...
func (r *traceabilityRepository) GetLatestComplianceReport(ctx context.Context, recordID, tenantID string) (*domain.ComplianceReport, error) {
	query := `SELECT id, tenant_id, record_id, status, report_type,
		findings, recommendations, auditor, audit_date,
		next_audit_date, compliance_score, metadata, created_at
