...
func TestCompensationLogRepositoryGetLogs_Success(t *testing.T) {
	...
	ctx := context.Background()
	log1 := &CompensationLog{StepNumber: 1, CompensationStepNum: 1, Status: models.StepStatusSucceeded}
	log2 := &CompensationLog{StepNumber: 2, CompensationStepNum: 1, Status: models.StepStatusSucceeded}
...
func TestCompensationLogRepositoryDeleteLogs_Success(t *testing.T) {
	...
	ctx := context.Background()
	log := &CompensationLog{StepNumber: 1, Status: models.StepStatusSucceeded}
...
func TestCompensationLogRepositoryClearLogs(t *testing.T) {
	...
	ctx := context.Background()
	log1 := &CompensationLog{StepNumber: 1, Status: models.StepStatusSucceeded}
	log2 := &CompensationLog{StepNumber: 2, Status: models.StepStatusSucceeded}
