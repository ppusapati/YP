...
//	})
func (r *RepositoryCircuitBreaker) Wrap(ctx context.Context, operation string, fn func() (interface{}, error)) (interface{}, error) {
	return r.cb.ExecuteWithResult(ctx, r.repoName, operation, fn)
}
...
//	})
func (r *RepositoryCircuitBreaker) WrapNoResult(ctx context.Context, operation string, fn func() error) error {
	return r.cb.Execute(ctx, r.repoName, operation, fn)
}
