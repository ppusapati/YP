...
use crop_recommendation_engine::{
    CropCandidate, CropRecommendationEngine, GrowingConditions,
    ...
    pub fn recommend_crops(
        ...
        let recommendations: Vec<proto::CropRecommendation> = ranked
            ...
            .map(|r| proto::CropRecommendation {
                crop_name: r.name.clone(),
                scientific_name: String::new(),
                category: String::new(),
                suitability_score: r.score.overall,
                confidence: r.score.overall,
                expected_yield_kg_per_ha: r.score.yield_factor * 1000.0,
                expected_profit_per_ha: r.score.estimated_revenue_per_ha,
                water_requirement_mm: 0.0,
                rationale: format!(
                    "Suitability score {:.2} based on soil, climate, and water availability analysis",
                    r.score.overall
                ),
                risk_factors: r.limiting_factors.clone(),
            })
            .collect();
...
fn default_crop_candidates() -> Vec<CropCandidate> {
    vec![
        ...
        CropCandidate {
            ...
            ideal_yield_kg_ha: 4500.0,
            market_price_per_kg: 0.35,
            production_cost_per_ha: 800.0,
        },
        CropCandidate {
            name: "Corn".to_string(),
            ph_range: (5.8, 7.0),
            temperature_range: (18.0, 32.0),
            water_requirement_mm: 600.0,
            min_growing_days: 130,
        ...
        CropCandidate {
            ...
            suitable_drainage: vec![DrainageClass::Well, DrainageClass::Moderate],
            ideal_yield_kg_ha: 1800.0,
            market_price_per_kg: 1.50,
            production_cost_per_ha: 900.0,
        },
        CropCandidate {
            name: "Potato".to_string(),
            ph_range: (4.8, 6.5),
            temperature_range: (12.0, 24.0),
            water_requirement_mm: 500.0,
            ...
            suitable_drainage: vec![DrainageClass::Well, DrainageClass::Moderate],
            ideal_yield_kg_ha: 20000.0,
            market_price_per_kg: 0.20,
            production_cost_per_ha: 1200.0,
        },
        CropCandidate {
            name: "Sugarcane".to_string(),
            ph_range: (5.0, 8.5),
            temperature_range: (20.0, 38.0),
            water_requirement_mm: 1500.0,
            min_growing_days: 300,
            min_sunlight_hours: 7.0,
            nitrogen_requirement: 50.0,
            phosphorus_requirement: 20.0,
            potassium_requirement: 40.0,
            suitable_textures: vec![SoilTexture::Loam, SoilTexture::ClayLoam, SoilTexture::SiltLoam],
            suitable_drainage: vec![DrainageClass::Well, DrainageClass::Moderate],
            ideal_yield_kg_ha: 70000.0,
            market_price_per_kg: 0.03,
            production_cost_per_ha: 1500.0,
        },
    ]
}
