<script lang="ts">
  ...
  function getFieldComponent(
    ...
    const componentMap: Partial<Record<string, any>> = {
      ...
      cron: CronInput,
      array: Input, // Placeholder - would need custom repeater
      object: Input, // Placeholder - would need custom group
      hidden: Input, // Placeholder - renders nothing
      custom: Input, // Placeholder - would need custom handler
    } as const;
