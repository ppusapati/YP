...
export const MODULE_REGISTRY: ModuleDef[] = [
  ...
  // ─── Agriculture Module Groups ──────────────────────────────────────────
  {
    ...
    icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2zM9 22V12h6v10M3 9h18',
    order: 22,
    sections: [
      {
  ...
  },
  {
    ...
    icon: 'M12 2a10 10 0 110 20 10 10 0 010-20zM2 12h20M12 2a15 15 0 014 10 15 15 0 01-4 10M12 2a15 15 0 00-4 10 15 15 0 004 10',
    order: 23,
    sections: [
      {
