...
import (
	...
	eventsadapter "p9e.in/samavaya/agriculture/soil-service/internal/adapters/inbound/events"
...
func main() {
	...
	// Build the raw sarama sync producer used by the outbound Kafka adapter.
	...
	svc := application.NewSoilService(repo, outboxPub, fieldClient, farmClient, pool, logger)
	...
	const serviceName = "soil-service"
	...
	if kafkaBroker != "" {
		eventConsumer := eventsadapter.NewSoilConsumer(svc, logger)
